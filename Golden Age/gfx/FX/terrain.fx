...
float4 PixelShader_Map( VS_OUTPUT v ) : COLOR
{
	...
	// OPTIMIZACIÓN EXTREMA: Se reemplaza la ecuación manual por lerp de hardware para ps_1_1
	float4 OutColor = lerp(BaseColor, TerrainColor, TerrainColor.a) * v.vLightIntensity.x;
...
float4 PixelShader_Beach( VS_OUTPUT_BEACH v ) : COLOR
{
	...
	// OPTIMIZACIÓN EXTREMA: Reemplazo de mezcla manual por interpolación nativa
