...
country = {
	...
	BASE_MONTHLY_DIPLOPOINTS = 0.7, -- Base value gain for diplomatic actions each month
	...
	COLONIZATION_COLONY_STATE_DISTANCE = 100,
...
military = {
	...
	AI_ARMY_TAXBASE_FRACTION = 0.9, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
...
ai =
{
	...
	CHANCE_BUILD_FORT = 0.005,
	CHANCE_INVEST_POP_PROJ = 0.9,
	CHANCE_FOREIGN_INVEST = 0.2,
	TWS_AWARENESS_SCORE_LOW_CAP = 0.25, -- AI will always add CBs if current warscore is less then that number (including TWS)
	TWS_AWARENESS_SCORE_ASPECT = 0.70, -- AI will not add any more CBs when TWS is more then X% of total WS. (to not destroy the progress)
	...
	AGGRESSION_BASE = 120, -- general AI aggression
