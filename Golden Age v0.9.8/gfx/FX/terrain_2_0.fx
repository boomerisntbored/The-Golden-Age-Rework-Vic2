...
float4 PixelShader_Map2_0_General( VS_MAP_OUTPUT v ) : COLOR
{
	...
	float3 ParchmentColor = float3(0.88, 0.85, 0.75);
    ...
    GreyTerrain.rgb = lerp(GreyTerrain.rgb, float3( 0.85, 0.85, 0.85 ), 0.35);  
	...
	UncolonisedTerrainColor.rgb = lerp(TerrainColor.rgb, ParchmentColor, 0.35);
